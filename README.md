...
Les données RECO sont celles en sortie de l'algorithme de reconstruction. Les scripts sont repris [ici](https://github.com/valsdav/DeepSuperCluster/tree/master/Evaluation/GraphSC/reco_comparison).
